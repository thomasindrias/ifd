...
### Fixed
- Corrected marketplace.json schema (was using plugin metadata format instead of marketplace format)
- Added dependency information to plugin description for visibility
- Enhanced README with Prerequisites section and installation commands

### Changed
- README now includes clear installation instructions for required plugins (superpowers, issue-dev)
